...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center mt-3 mb-4">Edit Data Pemilih</h2>
        <div class="card">
            <div class="card-body">
                <form action="/updatepemilih/{{ $data->id}}" method="POST" class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    {{-- <div class="col-md-6">
                      ...
                      <input type="password" name="password"{{ $data->password }}  class="form-control" id="inputPassword4">
                    </div> --}}
                    <div class="col-md-6">
                      <label for="inputPassword4" class="form-label">NISN</label>
                      <input type="number" name="NISN" value="{{ $data->NISN }}" class="form-control" id="inputPassword4">
                    </div>
                    <div class="col-md-12">
                      <label for="inputPassword4" class="form-label">Alamat</label>
                      <input type="text" name="alamat" value="{{ $data->alamat }}" class="form-control" id="inputPassword4">
                    </div>
