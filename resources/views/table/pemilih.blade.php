...
<body>
    ...
    <div class="container mt-5">
        <a href="/tambahP"><button class="btn btn-success">Tambah +</button></a>
        <div class="row">
            <div class="card-body">
                <table class="table table-Active table-hover shadow-lg">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $dt->alamat}}</td>
                      <td>
                        <a href="/deleteP/{{ $dt->id}}"><button class="btn btn-danger">Hapus</button></a>
                        <a href="/formedit/{{ $dt->id}}"><button class="btn btn-warning">Edit</button></a>
